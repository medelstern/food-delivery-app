...
//    @IBOutlet weak var selectDeliveryLabel: UILabel!
    static var selectedCollection:Bool =  false
...
//        }
        if(AppConstants.addressList.count == 1)
        {
    ...
    @IBAction func tapDeliverySel(_ sender: UIButton) {
        ...
        PlaceOrderVC.selectedCollection = false
    ...
    @IBAction func tapCollectionSel(_ sender: UIButton) {
        PlaceOrderVC.selectedCollection = true
        isCollectionTV = true
